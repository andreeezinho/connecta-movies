...
?>
    ...
    <div class="container pb-5">
        ...
        <div class="row justify-content-center">
            <form action="/dashboard/series/<?= $serie->uuid ?>/temporadas/cadastro" method="POST" class="card col-12 py-2 mt-1" enctype="multipart/form-data">
                <?php
                    if(isset($erro)){
                ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group text-center">
                        <a href="/dashboard/series/<?= $serie->uuid ?>/temporadas" class="btn btn-secondary mx-1">Cancelar</a>
