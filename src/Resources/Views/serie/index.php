...
<div class="container">
    <div class="row gx-3 mb-2">
        ...
        <div class="col-4 col-xl-6">
            <div class="float-end">
                <a href="/dashboard/series/cadastro" class="btn btn-outline-dark"> + <i class="bi-camera-reels"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        ...
        <a href="/series" class="btn btn-secondary">Limpar</a>
    </div>
    ...
    <div class="modal fade" id="filtro-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="/series" method="GET" class="modal-content">
    ...
    <div class="row mt-3 g-3 pb-4">
        ...
        ?>
            <div class="col-6 col-md-4 col-lg-2">
                <div data-toggle="modal" data-target="#serie-<?= $serie->uuid ?>" class="border-0">
                ...
                <div class="modal fade" id="serie-<?= $serie->uuid ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content text-dark py-2">
                            ...
                            <div class="modal-body">
                                <p class="text-muted"><?= $serie->nome ?></p>
                                <p class="mt-3 text-muted">
                                    <i class="bi-circle-fill small <?= ($serie->ativo == 1) ? 'text-success' : 'text-danger' ?>"></i>  
                                    <?= ($serie->ativo == 1) ? 'Ativo' : 'Inativo' ?>
                                </p>
                            </div>
                            <div class="modal-footer justify-content-center">
                                <div class="">
                                        <a href="/series/<?= $serie->uuid ?>/editar" class="btn btn-primary"><i class="bi-pencil-fill"></i></a>
                                        <a href="/series/<?= $serie->uuid ?>" class="btn btn-dark"><i class="bi-eye-fill"></i></a>
                                        ...
                                        <div class="modal fade" id="serie-delete-<?= $serie->uuid ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content text-dark py-5">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle"><i class="bi-camera-reels"></i> Remover serie?</h5>
                                                        </div>

                                                        <div class="modal-body">
                                                            <p class="">Deseja deletar o serie: <b><?= $serie->nome ?></b>?</p>
                                                        </div>

                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                            <form action="/series/<?= $serie->uuid ?>/deletar" method="POST">
